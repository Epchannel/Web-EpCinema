            ...
            <form action="" method="post">
                ...
                <div>
                    <label for="link" class="col-md-2">
                        Link tập phim từ OneDrive
                    </label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="video_link" name="video"
                            placeholder="Nhập link video từ OneDrive">
                        <p class="help-block">
                            Ví dụ: https://onedrive.live.com/...
                        </p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <button type="submit" class="btn btn-primary" id="button_post" name="button_post">Thêm tập phim
                        </button>
                    </div>
                </div>
            </form>
